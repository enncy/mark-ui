import { defineComponent, toRefs, createVNode, ref as ref$1, onMounted, nextTick, computed, watch as watch$1, withDirectives, resolveDirective } from "vue";
...
const MdRender = defineComponent({
  ...
  setup(props, {
    ...
    if (raw.value) {
      ...
      result = computed(() => markdown$1.render((content == null ? void 0 : content.value) || ""));
    ...
    return () => {
      ...
      }, [raw.value ? (_a2 = slots.default) == null ? void 0 : _a2.call(slots) : createVNode("div", {
