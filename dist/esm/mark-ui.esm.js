import { defineComponent, toRefs, createVNode, ref as ref$1, nextTick, computed, watch as watch$1, withDirectives, resolveDirective } from "vue";
...
var bare = function emoji_plugin(md, options) {
  ...
  var opts = normalize_opts2(md.utils.assign({}, defaults, options || {}));
...
markdown.use(markdownItEmoji).use(Container).use(b, {
  permalink: true,
...
const MdRender = defineComponent({
  name: "MdRender",
  props: {
    content: {
      type: String,
  ...
  setup(props, {
    ...
    if (raw.value) {
      nextTick(() => {
        var _a2;
        const html = ((_a2 = getRender(renderKey.value)) == null ? void 0 : _a2.innerHTML) || "";
        result.value = markdown.render(html.replace(/\n/g, "<br>") || "");
      });
    } else {
      result = computed(() => markdown.render((content == null ? void 0 : content.value) || ""));
      let content_cache = ((_a = content.value) == null ? void 0 : _a.split("\n")) || [];
      let temp_line = -1;
      watch$1(result, async () => {
        var _a2, _b;
        await nextTick();
...
const MdStyleSelector = defineComponent({
  ...
  setup(props, {
    ...
    return () => withDirectives(createVNode("select", {
      ...
      return withDirectives(createVNode("option", {
        "textContent": css
      }, null), [[resolveDirective("model-selected"), css === (defaultStyle.value || HljsStyleEnums$1["github-dark"])]]);
    })]), [[resolveDirective("on-change"), onChange]]);
  }
});
...
export { HljsStyleEnums$1 as HljsStyleEnums, MdEditor, MdRender, MdStyleSelector, MarkUI as default };
